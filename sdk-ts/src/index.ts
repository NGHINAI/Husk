...
export class Husk {
  ...
  async createSession(options: { profile?: string; parent_session_id?: string; engine?: "lightpanda" | "chrome" | "auto" } = {}): Promise<Session & { watchUrl: string | null }> {
    ...
    if (options.engine !== undefined) params["engine"] = options.engine;
